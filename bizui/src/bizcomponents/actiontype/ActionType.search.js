...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{actionTypeList:selectedRows}} owner={owner}  
...
class ActionTypeSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ActionTypeTable} = GlobalComponents;
    const {ActionTypeSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ActionTypeSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ActionTypeModalTable,"actionTypeIds")}
...
export default Form.create()(ActionTypeSearch)
