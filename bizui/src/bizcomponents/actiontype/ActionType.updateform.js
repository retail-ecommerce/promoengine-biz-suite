...
import styles from './ActionType.updateform.less'
...
class ActionTypeUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const actionTypeId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, actionTypeId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateActionType`,
          payload: {
            id: owner.id,
            type: 'actionType',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextActionTypeUpdateRow`,
        payload: {
          id: owner.id,
          type: 'actionType',
          selectedRows,
...
}))(Form.create()(ActionTypeUpdateForm))
