...
import styles from './ActionType.search.less'
...
class ActionTypeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      actionTypeList: 1,
      'actionTypeList.searchField': fieldName,
      'actionTypeList.searchVerb': 'startsWith',
      'actionTypeList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`actionTypeList.searchField`] = fieldName
    value[`actionTypeList.searchVerb`] =  searchVerb
    value[`actionTypeList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['actionTypeList'] = 1
      params['actionTypeList.orderBy.0'] = "id"
      params['actionTypeList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        actionTypeSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={ActionTypeService.requestCandidatePlatform}/>
...
export default Form.create()(ActionTypeSearchForm)
