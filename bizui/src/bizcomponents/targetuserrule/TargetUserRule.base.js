...
const menuData = {menuName:"Target User Rule", menuFor: "targetUserRule",
  		subItems: [
...
const displayColumns = [
  ...
  { title: 'Apply Condition', dataIndex: 'applyCondition', render: (text, record) => renderReferenceCell(text, record)},
...
const TargetUserRuleBase={menuData,displayColumns,fieldLabels}
export default TargetUserRuleBase
