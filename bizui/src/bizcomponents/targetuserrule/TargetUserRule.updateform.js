...
import styles from './TargetUserRule.updateform.less'
...
class TargetUserRuleUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const targetUserRuleId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, targetUserRuleId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateTargetUserRule`,
          payload: {
            id: owner.id,
            type: 'targetUserRule',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextTargetUserRuleUpdateRow`,
        payload: {
          id: owner.id,
          type: 'targetUserRule',
          selectedRows,
              ...
              <Col lg={12} md={12} sm={24}>
                <Form.Item label={fieldLabels.parameter} {...formItemLayout}>
                  {getFieldDecorator('parameter', {
                    initialValue: selectedRow.parameter,
                    rules: [{ required: true, message: appLocaleName(userContext,"PleaseInput") }],
                  })(
...
}))(Form.create()(TargetUserRuleUpdateForm))
