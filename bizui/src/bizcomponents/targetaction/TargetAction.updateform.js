...
import styles from './TargetAction.updateform.less'
...
class TargetActionUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const targetActionId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, targetActionId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateTargetAction`,
          payload: {
            id: owner.id,
            type: 'targetAction',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextTargetActionUpdateRow`,
        payload: {
          id: owner.id,
          type: 'targetAction',
          selectedRows,
...
}))(Form.create()(TargetActionUpdateForm))
