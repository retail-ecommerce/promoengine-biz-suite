...
import styles from './TargetAction.search.less'
...
class TargetActionSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      targetActionList: 1,
      'targetActionList.searchField': fieldName,
      'targetActionList.searchVerb': 'startsWith',
      'targetActionList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`targetActionList.searchField`] = fieldName
    value[`targetActionList.searchVerb`] =  searchVerb
    value[`targetActionList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'action'))
      ...
      params['targetActionList'] = 1
      params['targetActionList.orderBy.0'] = "id"
      params['targetActionList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        targetActionSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                    initialValue: tryinit('action'),
                   
                  })(
                  
                  <SelectObject 
                    disabled={!availableForEdit('action')}
                    targetType={"action"} 
                    requestFunction={TargetActionService.requestCandidateAction}/>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={TargetActionService.requestCandidatePromotion}/>
...
export default Form.create()(TargetActionSearchForm)
