...
class PlatformDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const { id,displayName, applyConditionListMetaInfo, actionTypeListMetaInfo, promotionLevelListMetaInfo, promotionListMetaInfo, applyConditionCount, actionTypeCount, promotionLevelCount, promotionCount } = this.props.platform
    ...
    const cardsData = {cardsName:"Platform",cardsFor: "platform",
    	cardsSource: this.props.platform,returnURL,displayName,
  		subItems: [
{name: 'applyConditionList', displayName:'Apply Condition',type:'applyCondition',count:applyConditionCount,addFunction: true, role: 'applyCondition', metaInfo: applyConditionListMetaInfo},
{name: 'actionTypeList', displayName:'Action Type',type:'actionType',count:actionTypeCount,addFunction: true, role: 'actionType', metaInfo: actionTypeListMetaInfo},
{name: 'promotionLevelList', displayName:'Promotion Level',type:'promotionLevel',count:promotionLevelCount,addFunction: true, role: 'promotionLevel', metaInfo: promotionLevelListMetaInfo},
{name: 'promotionList', displayName:'Promotion',type:'promotion',count:promotionCount,addFunction: true, role: 'promotion', metaInfo: promotionListMetaInfo},
