...
class PlatformAssociateForm extends Component {
 ...
 const {ActionTypeModalTable} = GlobalComponents;
 const {PromotionLevelModalTable} = GlobalComponents;
 const {PromotionModalTable} = GlobalComponents;
 ...
 <Modal
	...
	<ApplyConditionModalTable data={data.applyConditionList} owner={owner} />
	<ActionTypeModalTable data={data.actionTypeList} owner={owner} />
	<PromotionLevelModalTable data={data.promotionLevelList} owner={owner} />
	<PromotionModalTable data={data.promotionList} owner={owner} />
