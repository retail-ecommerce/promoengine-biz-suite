...
import styles from './ApplyCondition.search.less'
...
class ApplyConditionSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      applyConditionList: 1,
      'applyConditionList.searchField': fieldName,
      'applyConditionList.searchVerb': 'startsWith',
      'applyConditionList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`applyConditionList.searchField`] = fieldName
    value[`applyConditionList.searchVerb`] =  searchVerb
    value[`applyConditionList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['applyConditionList'] = 1
      params['applyConditionList.orderBy.0'] = "id"
      params['applyConditionList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        applyConditionSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={ApplyConditionService.requestCandidatePlatform}/>
...
export default Form.create()(ApplyConditionSearchForm)
