...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{applyConditionList:selectedRows}} owner={owner}  
...
class ApplyConditionSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ApplyConditionTable} = GlobalComponents;
    const {ApplyConditionSearchForm} = GlobalComponents;
    const {ApplyConditionModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ApplyConditionSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ApplyConditionModalTable,"applyConditionIds")}
...
export default Form.create()(ApplyConditionSearch)
