...
import styles from './ApplyCondition.updateform.less'
...
class ApplyConditionUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const applyConditionId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, applyConditionId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateApplyCondition`,
          payload: {
            id: owner.id,
            type: 'applyCondition',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextApplyConditionUpdateRow`,
        payload: {
          id: owner.id,
          type: 'applyCondition',
          selectedRows,
...
}))(Form.create()(ApplyConditionUpdateForm))
