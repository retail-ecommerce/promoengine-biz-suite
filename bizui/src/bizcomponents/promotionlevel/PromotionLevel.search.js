...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{promotionLevelList:selectedRows}} owner={owner}  
...
class PromotionLevelSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {PromotionLevelTable} = GlobalComponents;
    const {PromotionLevelSearchForm} = GlobalComponents;
    const {PromotionLevelModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <PromotionLevelSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,PromotionLevelModalTable,"promotionLevelIds")}
...
export default Form.create()(PromotionLevelSearch)
