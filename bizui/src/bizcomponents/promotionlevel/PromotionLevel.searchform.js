...
import styles from './PromotionLevel.search.less'
...
class PromotionLevelSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      promotionLevelList: 1,
      'promotionLevelList.searchField': fieldName,
      'promotionLevelList.searchVerb': 'startsWith',
      'promotionLevelList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`promotionLevelList.searchField`] = fieldName
    value[`promotionLevelList.searchVerb`] =  searchVerb
    value[`promotionLevelList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['promotionLevelList'] = 1
      params['promotionLevelList.orderBy.0'] = "id"
      params['promotionLevelList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        promotionLevelSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={PromotionLevelService.requestCandidatePlatform}/>
...
export default Form.create()(PromotionLevelSearchForm)
