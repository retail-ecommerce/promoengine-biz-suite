...
import styles from './PromotionLevel.updateform.less'
...
class PromotionLevelUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const promotionLevelId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, promotionLevelId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updatePromotionLevel`,
          payload: {
            id: owner.id,
            type: 'promotionLevel',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextPromotionLevelUpdateRow`,
        payload: {
          id: owner.id,
          type: 'promotionLevel',
          selectedRows,
...
}))(Form.create()(PromotionLevelUpdateForm))
