...
import styles from './Promotion.search.less'
...
class PromotionSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      promotionList: 1,
      'promotionList.searchField': fieldName,
      'promotionList.searchVerb': 'startsWith',
      'promotionList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`promotionList.searchField`] = fieldName
    value[`promotionList.searchVerb`] =  searchVerb
    value[`promotionList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['promotionList'] = 1
      params['promotionList.orderBy.0'] = "id"
      params['promotionList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        promotionSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(PromotionSearchForm)
