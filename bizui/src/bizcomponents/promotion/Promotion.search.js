...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{promotionList:selectedRows}} owner={owner}  
...
class PromotionSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {PromotionTable} = GlobalComponents;
    const {PromotionSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <PromotionSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,PromotionModalTable,"promotionIds")}
...
export default Form.create()(PromotionSearch)
