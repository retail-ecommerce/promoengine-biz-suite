...
import styles from './PromotionOffer.updateform.less'
...
class PromotionOfferUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const promotionOfferId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, promotionOfferId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updatePromotionOffer`,
          payload: {
            id: owner.id,
            type: 'promotionOffer',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextPromotionOfferUpdateRow`,
        payload: {
          id: owner.id,
          type: 'promotionOffer',
          selectedRows,
...
}))(Form.create()(PromotionOfferUpdateForm))
