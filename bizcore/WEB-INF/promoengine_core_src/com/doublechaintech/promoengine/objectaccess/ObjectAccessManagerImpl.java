...
public class ObjectAccessManagerImpl extends CustomPromoengineCheckerManager implements ObjectAccessManager {
	...
	protected void throwExceptionWithMessage(String value) throws ObjectAccessManagerException{
 	...
 	protected ObjectAccess saveObjectAccess(PromoengineUserContext userContext, ObjectAccess objectAccess, String [] tokensExpr) throws Exception{	
 	...
 	protected ObjectAccess saveObjectAccessDetail(PromoengineUserContext userContext, ObjectAccess objectAccess) throws Exception{	

 		
 		return saveObjectAccess(userContext, objectAccess, allTokens());
 	}
 	
 	public ObjectAccess loadObjectAccess(PromoengineUserContext userContext, String objectAccessId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ObjectAccess searchObjectAccess(PromoengineUserContext userContext, String objectAccessId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ObjectAccess present(PromoengineUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens) throws Exception {
 	...
 	public ObjectAccess loadObjectAccessDetail(PromoengineUserContext userContext, String objectAccessId) throws Exception{	
 	...
 	public Object view(PromoengineUserContext userContext, String objectAccessId) throws Exception{	
 		ObjectAccess objectAccess = loadObjectAccess( userContext, objectAccessId, viewTokens());
 		return present(userContext,objectAccess, allTokens());
		
 	}
 	protected ObjectAccess saveObjectAccess(PromoengineUserContext userContext, ObjectAccess objectAccess, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getObjectAccessDAO().save(objectAccess, tokens);
 	}
 	protected ObjectAccess loadObjectAccess(PromoengineUserContext userContext, String objectAccessId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfObjectAccess(objectAccessId);
		userContext.getChecker().throwExceptionIfHasErrors( ObjectAccessManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(PromoengineUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(PromoengineUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens){
	...
	public ObjectAccess createObjectAccess(PromoengineUserContext userContext,String name, String objectType, String list1, String list2, String list3, String list4, String list5, String list6, String list7, String list8, String list9, String appId) throws Exception
	{
	...
	protected void checkParamsForUpdatingObjectAccess(PromoengineUserContext userContext,String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ObjectAccess clone(PromoengineUserContext userContext, String fromObjectAccessId) throws Exception{
		
		return userContext.getDAOGroup().getObjectAccessDAO().clone(fromObjectAccessId, this.allTokens());
	}
	
	public ObjectAccess internalSaveObjectAccess(PromoengineUserContext userContext, ObjectAccess objectAccess) throws Exception 
	{
		return internalSaveObjectAccess(userContext, objectAccess, allTokens());

	}
	public ObjectAccess internalSaveObjectAccess(PromoengineUserContext userContext, ObjectAccess objectAccess, Map<String,Object> options) throws Exception 
	{
	...
	public ObjectAccess updateObjectAccess(PromoengineUserContext userContext,String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingObjectAccess(userContext, objectAccessId, objectAccessVersion, property, newValueExpr, tokensExpr);
	...
	public ObjectAccess updateObjectAccessProperty(PromoengineUserContext userContext,String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingObjectAccess(userContext, objectAccessId, objectAccessVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(PromoengineUserContext userContext, String objectAccessId, String anotherAppId) throws Exception
 	{
 	...
 	public ObjectAccess transferToAnotherApp(PromoengineUserContext userContext, String objectAccessId, String anotherAppId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(PromoengineUserContext userContext, String objectAccessId, int objectAccessVersion) throws Exception {
	...
	public ObjectAccess forgetByAll(PromoengineUserContext userContext, String objectAccessId, int objectAccessVersion) throws Exception {
		return forgetByAllInternal(userContext, objectAccessId, objectAccessVersion);		
	}
	protected ObjectAccess forgetByAllInternal(PromoengineUserContext userContext,
			String objectAccessId, int objectAccessVersion) throws Exception{
	...
	public void onNewInstanceCreated(PromoengineUserContext userContext, ObjectAccess newCreated) throws Exception{
