...
public class BaseRelation{
	...
	protected void prepareRelationIndex()
	{
		...
		addRelationIndex("ApplyCondition",applyConditionRelatedObjectNames);

		String [] actionTypeRelatedObjectNames = {"platform:Platform"};
		addRelationIndex("ActionType",actionTypeRelatedObjectNames);

		String [] promotionLevelRelatedObjectNames = {"platform:Platform"};
		addRelationIndex("PromotionLevel",promotionLevelRelatedObjectNames);

		String [] promotionRelatedObjectNames = {"platform:Platform"};
		addRelationIndex("Promotion",promotionRelatedObjectNames);

		String [] targetUserRuleRelatedObjectNames = {"apply_condition:ApplyCondition","promotion:Promotion"};
		addRelationIndex("TargetUserRule",targetUserRuleRelatedObjectNames);

		String [] targetActionRelatedObjectNames = {"action:ActionType","promotion:Promotion"};
		addRelationIndex("TargetAction",targetActionRelatedObjectNames);

		String [] promotionOfferRelatedObjectNames = {"promotion_level:PromotionLevel","promotion:Promotion"};
		addRelationIndex("PromotionOffer",promotionOfferRelatedObjectNames);
	...
	{
		addGenericRelation("ApplyCondition"                        ,TRUST_CHAIN_READ,"platform");
		addGenericRelation("ActionType"                            ,TRUST_CHAIN_READ,"platform");
		addGenericRelation("PromotionLevel"                        ,TRUST_CHAIN_READ,"platform");
		addGenericRelation("Promotion"                             ,TRUST_CHAIN_READ,"platform");
		addGenericRelation("TargetUserRule"                        ,TRUST_CHAIN_READ,"applyCondition");
		addGenericRelation("TargetUserRule"                        ,TRUST_CHAIN_READ,"promotion");
		addGenericRelation("TargetAction"                          ,TRUST_CHAIN_READ,"action");
		addGenericRelation("TargetAction"                          ,TRUST_CHAIN_READ,"promotion");
		addGenericRelation("PromotionOffer"                        ,TRUST_CHAIN_READ,"promotionLevel");
		addGenericRelation("PromotionOffer"                        ,TRUST_CHAIN_READ,"promotion");
