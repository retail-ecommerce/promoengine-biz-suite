...
@JsonSerialize(using = PromoengineExceptionJsonSerializer.class)
public class PromoengineException extends Exception implements MessageContainer {
    ...
    public PromoengineException(Message message) {
    	super();
        this.addErrorMessage(message);
    }
	public PromoengineException(List<Message> messageList) {
        super();
    ...
    public PromoengineException(String message, Throwable cause) {
        super(message, cause);
    }


    public PromoengineException(Throwable cause) {
        super(cause);
    }
