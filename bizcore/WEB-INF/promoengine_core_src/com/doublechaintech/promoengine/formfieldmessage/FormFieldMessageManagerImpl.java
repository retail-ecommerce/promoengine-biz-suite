...
public class FormFieldMessageManagerImpl extends CustomPromoengineCheckerManager implements FormFieldMessageManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormFieldMessageManagerException{
 	...
 	protected FormFieldMessage saveFormFieldMessage(PromoengineUserContext userContext, FormFieldMessage formFieldMessage, String [] tokensExpr) throws Exception{	
 	...
 	protected FormFieldMessage saveFormFieldMessageDetail(PromoengineUserContext userContext, FormFieldMessage formFieldMessage) throws Exception{	
 	...
 	public FormFieldMessage loadFormFieldMessage(PromoengineUserContext userContext, String formFieldMessageId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormFieldMessage searchFormFieldMessage(PromoengineUserContext userContext, String formFieldMessageId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormFieldMessage present(PromoengineUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens) throws Exception {
 	...
 	public FormFieldMessage loadFormFieldMessageDetail(PromoengineUserContext userContext, String formFieldMessageId) throws Exception{	
 	...
 	public Object view(PromoengineUserContext userContext, String formFieldMessageId) throws Exception{	
 		FormFieldMessage formFieldMessage = loadFormFieldMessage( userContext, formFieldMessageId, viewTokens());
 		return present(userContext,formFieldMessage, allTokens());
		
 	}
 	protected FormFieldMessage saveFormFieldMessage(PromoengineUserContext userContext, FormFieldMessage formFieldMessage, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormFieldMessageDAO().save(formFieldMessage, tokens);
 	}
 	protected FormFieldMessage loadFormFieldMessage(PromoengineUserContext userContext, String formFieldMessageId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormFieldMessage(formFieldMessageId);
		userContext.getChecker().throwExceptionIfHasErrors( FormFieldMessageManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(PromoengineUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(PromoengineUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormFieldMessage(PromoengineUserContext userContext,String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormFieldMessage clone(PromoengineUserContext userContext, String fromFormFieldMessageId) throws Exception{
	...
	public FormFieldMessage internalSaveFormFieldMessage(PromoengineUserContext userContext, FormFieldMessage formFieldMessage, Map<String,Object> options) throws Exception 
	{
	...
	public FormFieldMessage updateFormFieldMessageProperty(PromoengineUserContext userContext,String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormFieldMessage(userContext, formFieldMessageId, formFieldMessageVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(PromoengineUserContext userContext, String formFieldMessageId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(PromoengineUserContext userContext, String formFieldMessageId, int formFieldMessageVersion) throws Exception {
	...
	public FormFieldMessage forgetByAll(PromoengineUserContext userContext, String formFieldMessageId, int formFieldMessageVersion) throws Exception {
		return forgetByAllInternal(userContext, formFieldMessageId, formFieldMessageVersion);		
	}
	protected FormFieldMessage forgetByAllInternal(PromoengineUserContext userContext,
			String formFieldMessageId, int formFieldMessageVersion) throws Exception{
