...
public class SecUserBlockingJDBCTemplateDAO extends PromoengineNamingServiceDAO implements SecUserBlockingDAO{
	...
	*/
    ...
    public SmartList<SecUserBlocking> requestCandidateSecUserBlockingForSecUser(PromoengineUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
