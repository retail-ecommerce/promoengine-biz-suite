...
public class PromoengineExceptionJsonSerializer extends  JsonSerializer<PromoengineException> {
	...
	@Override
	public void serialize(PromoengineException exception, JsonGenerator jgen,
	...
	protected void writeExceptionMessage(String message, PromoengineException exception,
	...
	protected void writeStartObject(PromoengineException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		jgen.writeStartObject();
		writeClassField(CLASS,exception,jgen,provider);
	}
	
	private static final String MESSAGE_LIST = "messageList";
	protected void writeEndObject(PromoengineException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		
		writeMessageList(MESSAGE_LIST,exception,jgen,provider);
		jgen.writeEndObject();
	}
	protected void writeClassField(String fieldName,PromoengineException exception,
	...
	protected void writeMessageList(String fieldName,PromoengineException exception,
			JsonGenerator jgen, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		if(exception == null){
			return; //do nothing when base entity is null
