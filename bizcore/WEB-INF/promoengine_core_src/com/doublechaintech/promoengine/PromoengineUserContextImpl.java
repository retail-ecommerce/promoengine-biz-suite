...
import com.doublechaintech.promoengine.secuser.SecUserCustomManagerImpl;
...
public class PromoengineUserContextImpl extends UserContextImpl implements PromoengineUserContext{
	...
	static final String RESOURCE_PATH="com.doublechaintech.promoengine.PromoengineResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechaintech.promoengine.PromoengineCustomResources";
    ...
    /*
    public static SecUser getSecUser(PromoengineUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(PromoengineUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(PromoengineUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(PromoengineUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
	...
	private PromoengineChecker checker;
