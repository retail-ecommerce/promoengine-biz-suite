...
public class UserWhiteListManagerImpl extends CustomPromoengineCheckerManager implements UserWhiteListManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserWhiteListManagerException{
 	...
 	protected UserWhiteList saveUserWhiteList(PromoengineUserContext userContext, UserWhiteList userWhiteList, String [] tokensExpr) throws Exception{	
 	...
 	protected UserWhiteList saveUserWhiteListDetail(PromoengineUserContext userContext, UserWhiteList userWhiteList) throws Exception{	
 	...
 	public UserWhiteList loadUserWhiteList(PromoengineUserContext userContext, String userWhiteListId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserWhiteList searchUserWhiteList(PromoengineUserContext userContext, String userWhiteListId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserWhiteList present(PromoengineUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens) throws Exception {
 	...
 	public UserWhiteList loadUserWhiteListDetail(PromoengineUserContext userContext, String userWhiteListId) throws Exception{	
 	...
 	public Object view(PromoengineUserContext userContext, String userWhiteListId) throws Exception{	
 		UserWhiteList userWhiteList = loadUserWhiteList( userContext, userWhiteListId, viewTokens());
 		return present(userContext,userWhiteList, allTokens());
		
 	}
 	protected UserWhiteList saveUserWhiteList(PromoengineUserContext userContext, UserWhiteList userWhiteList, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getUserWhiteListDAO().save(userWhiteList, tokens);
 	}
 	protected UserWhiteList loadUserWhiteList(PromoengineUserContext userContext, String userWhiteListId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfUserWhiteList(userWhiteListId);
		userContext.getChecker().throwExceptionIfHasErrors( UserWhiteListManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(PromoengineUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(PromoengineUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserWhiteList(PromoengineUserContext userContext,String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserWhiteList clone(PromoengineUserContext userContext, String fromUserWhiteListId) throws Exception{
	...
	public UserWhiteList internalSaveUserWhiteList(PromoengineUserContext userContext, UserWhiteList userWhiteList, Map<String,Object> options) throws Exception 
	{
	...
	public UserWhiteList updateUserWhiteListProperty(PromoengineUserContext userContext,String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserWhiteList(userContext, userWhiteListId, userWhiteListVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherDomain(PromoengineUserContext userContext, String userWhiteListId, String anotherDomainId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(PromoengineUserContext userContext, String userWhiteListId, int userWhiteListVersion) throws Exception {
	...
	public UserWhiteList forgetByAll(PromoengineUserContext userContext, String userWhiteListId, int userWhiteListVersion) throws Exception {
		return forgetByAllInternal(userContext, userWhiteListId, userWhiteListVersion);		
	}
	protected UserWhiteList forgetByAllInternal(PromoengineUserContext userContext,
			String userWhiteListId, int userWhiteListVersion) throws Exception{
