...
public class PromoengineNamingServiceDAO extends CommonJDBCTemplateDAO {
	...
	static {
		...
		namingTableMap.put("ApplyCondition", new String[]{"apply_condition_data","name"});
		namingTableMap.put("ActionType", new String[]{"action_type_data","name"});
		namingTableMap.put("PromotionLevel", new String[]{"promotion_level_data","name"});
		namingTableMap.put("Promotion", new String[]{"promotion_data","name"});
		namingTableMap.put("TargetUserRule", new String[]{"target_user_rule_data","name"});
		namingTableMap.put("TargetAction", new String[]{"target_action_data","name"});
		namingTableMap.put("PromotionOffer", new String[]{"promotion_offer_data","name"});
