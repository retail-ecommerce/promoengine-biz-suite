-- BUILD WITH MODEL TIME 190302T1452
drop database  if exists promoengine;
create database promoengine;
alter  database promoengine  character set = utf8mb4  collate = utf8mb4_unicode_ci; -- 支持表情符号
use promoengine;
...
drop table  if exists apply_condition_data;
create table apply_condition_data (
	id                  	varchar(64)          not null            comment 'Id',
...
drop table  if exists action_type_data;
create table action_type_data (
	id                  	varchar(64)          not null            comment 'Id',
	name                	varchar(96)                              comment 'Name',
	last_update_time    	datetime                                 comment 'Last Update Time',
	platform            	varchar(48)                              comment 'Platform',
	version             	int                                      comment 'Version',
	primary key(id)
...
drop table  if exists promotion_level_data;
create table promotion_level_data (
	id                  	varchar(64)          not null            comment 'Id',
...
create table promotion_data (
	...
	valid_after         	datetime                                 comment 'Valid After',
...
drop table  if exists target_user_rule_data;
create table target_user_rule_data (
	id                  	varchar(64)          not null            comment 'Id',
	name                	varchar(20)                              comment 'Name',
	apply_condition     	varchar(48)                              comment 'Apply Condition',
	parameter           	varchar(44)                              comment 'Parameter',
	last_update_time    	datetime                                 comment 'Last Update Time',
	promotion           	varchar(48)                              comment 'Promotion',
	version             	int                                      comment 'Version',
	primary key(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE = utf8mb4_unicode_ci ;

drop table  if exists target_action_data;
create table target_action_data (
	id                  	varchar(64)          not null            comment 'Id',
	name                	varchar(20)                              comment 'Name',
	action              	varchar(48)                              comment 'Action',
	parameter           	varchar(44)                              comment 'Parameter',
	last_update_time    	datetime                                 comment 'Last Update Time',
	promotion           	varchar(48)                              comment 'Promotion',
	version             	int                                      comment 'Version',
...
drop table  if exists promotion_offer_data;
create table promotion_offer_data (
	id                  	varchar(64)          not null            comment 'Id',
	name                	varchar(72)                              comment 'Name',
	promotion_level     	varchar(48)                              comment 'Promotion Level',
	parameter           	varchar(44)                              comment 'Parameter',
	promotion           	varchar(48)                              comment 'Promotion',
	version             	int                                      comment 'Version',
	primary key(id)
...
insert into apply_condition_data values ('AC000001','All','2019-02-25 07:37:25','P000001','1');
insert into apply_condition_data values ('AC000002','With Id','2019-02-09 08:10:05','P000001','1');
insert into apply_condition_data values ('AC000003','Has Property','2019-02-16 10:39:23','P000001','1');
insert into apply_condition_data values ('AC000004','In Group Of','2019-02-25 08:27:57','P000001','1');
insert into apply_condition_data values ('AC000005','All','2019-02-23 23:32:04','P000001','1');

	
insert into action_type_data values ('AT000001','View Home Page','2019-02-25 03:47:06','P000001','1');
insert into action_type_data values ('AT000002','View Category Page','2019-02-17 08:50:16','P000001','1');
insert into action_type_data values ('AT000003','View Product Detail Page','2019-02-17 17:18:18','P000001','1');
insert into action_type_data values ('AT000004','Add To Shopping Cart','2019-02-24 09:58:31','P000001','1');
insert into action_type_data values ('AT000005','Search','2019-03-01 13:02:01','P000001','1');

	
insert into promotion_level_data values ('PL000001','Order Level','2019-03-02 03:36:14','P000001','1');
insert into promotion_level_data values ('PL000002','Shipping','2019-02-22 21:37:34','P000001','1');
insert into promotion_level_data values ('PL000003','Line Item','2019-02-23 22:17:39','P000001','1');
insert into promotion_level_data values ('PL000004','Order Level','2019-02-18 06:58:33','P000001','1');
insert into promotion_level_data values ('PL000005','Shipping','2019-02-28 12:30:20','P000001','1');

	
insert into promotion_data values ('P000001','Good Day Promotion','2019-02-23 11:01:18','2019-02-23 19:05:37','2019-02-10 17:51:49','P000001','1');
insert into promotion_data values ('P000002','Good Day Promotion0002','2019-02-12 06:34:37','2019-02-16 01:36:16','2019-02-19 10:56:43','P000001','1');
insert into promotion_data values ('P000003','Good Day Promotion0003','2019-02-21 08:25:32','2019-02-19 19:30:06','2019-02-27 01:57:56','P000001','1');
insert into promotion_data values ('P000004','Good Day Promotion0004','2019-03-01 03:38:54','2019-02-23 18:22:50','2019-02-20 19:38:02','P000001','1');
insert into promotion_data values ('P000005','Good Day Promotion0005','2019-02-13 06:05:22','2019-02-28 02:54:17','2019-02-13 20:13:11','P000001','1');

	
insert into target_user_rule_data values ('TUR000001','rule1','AC000001','...','2019-02-15 11:14:18','P000001','1');
insert into target_user_rule_data values ('TUR000002','rule10002','AC000001','P000012','2019-02-26 02:34:17','P000001','1');
insert into target_user_rule_data values ('TUR000003','rule10003','AC000001','age>30','2019-02-14 10:42:05','P000001','1');
insert into target_user_rule_data values ('TUR000004','rule10004','AC000001','Young Girls','2019-02-28 14:01:21','P000001','1');
insert into target_user_rule_data values ('TUR000005','rule10005','AC000001','...','2019-02-18 13:20:10','P000001','1');
insert into target_user_rule_data values ('TUR000006','rule10006','AC000002','P000012','2019-02-16 19:54:41','P000002','1');
insert into target_user_rule_data values ('TUR000007','rule10007','AC000002','age>30','2019-02-09 09:21:27','P000002','1');
insert into target_user_rule_data values ('TUR000008','rule10008','AC000002','Young Girls','2019-02-25 04:47:19','P000002','1');
insert into target_user_rule_data values ('TUR000009','rule10009','AC000002','...','2019-02-27 02:01:07','P000002','1');
insert into target_user_rule_data values ('TUR000010','rule10010','AC000002','P000012','2019-02-22 15:17:56','P000002','1');
insert into target_user_rule_data values ('TUR000011','rule10011','AC000003','age>30','2019-02-13 01:03:02','P000003','1');
insert into target_user_rule_data values ('TUR000012','rule10012','AC000003','Young Girls','2019-02-21 02:44:18','P000003','1');
insert into target_user_rule_data values ('TUR000013','rule10013','AC000003','...','2019-02-25 10:58:26','P000003','1');
insert into target_user_rule_data values ('TUR000014','rule10014','AC000003','P000012','2019-02-15 07:58:22','P000003','1');
insert into target_user_rule_data values ('TUR000015','rule10015','AC000003','age>30','2019-02-28 20:45:14','P000003','1');
insert into target_user_rule_data values ('TUR000016','rule10016','AC000004','Young Girls','2019-02-24 10:24:27','P000004','1');
insert into target_user_rule_data values ('TUR000017','rule10017','AC000004','...','2019-02-11 05:17:04','P000004','1');
insert into target_user_rule_data values ('TUR000018','rule10018','AC000004','P000012','2019-02-14 11:31:58','P000004','1');
insert into target_user_rule_data values ('TUR000019','rule10019','AC000004','age>30','2019-02-19 04:49:43','P000004','1');
insert into target_user_rule_data values ('TUR000020','rule10020','AC000004','Young Girls','2019-02-23 07:46:16','P000004','1');
insert into target_user_rule_data values ('TUR000021','rule10021','AC000005','...','2019-02-14 01:41:39','P000005','1');
insert into target_user_rule_data values ('TUR000022','rule10022','AC000005','P000012','2019-02-24 20:30:24','P000005','1');
insert into target_user_rule_data values ('TUR000023','rule10023','AC000005','age>30','2019-02-21 18:28:40','P000005','1');
insert into target_user_rule_data values ('TUR000024','rule10024','AC000005','Young Girls','2019-02-24 02:03:57','P000005','1');
insert into target_user_rule_data values ('TUR000025','rule10025','AC000005','...','2019-02-22 00:30:26','P000005','1');

	
insert into target_action_data values ('TA000001','rule1','AT000001','...','2019-02-23 20:36:29','P000001','1');
insert into target_action_data values ('TA000002','rule10002','AT000001','P000012','2019-02-23 16:26:02','P000001','1');
insert into target_action_data values ('TA000003','rule10003','AT000001','age>30','2019-02-13 22:50:09','P000001','1');
insert into target_action_data values ('TA000004','rule10004','AT000001','Young Girls','2019-02-15 08:51:46','P000001','1');
insert into target_action_data values ('TA000005','rule10005','AT000001','...','2019-02-15 10:42:24','P000001','1');
insert into target_action_data values ('TA000006','rule10006','AT000002','P000012','2019-03-01 17:27:37','P000002','1');
insert into target_action_data values ('TA000007','rule10007','AT000002','age>30','2019-02-16 16:36:18','P000002','1');
insert into target_action_data values ('TA000008','rule10008','AT000002','Young Girls','2019-02-21 17:09:13','P000002','1');
insert into target_action_data values ('TA000009','rule10009','AT000002','...','2019-02-24 04:18:37','P000002','1');
insert into target_action_data values ('TA000010','rule10010','AT000002','P000012','2019-02-09 02:28:13','P000002','1');
insert into target_action_data values ('TA000011','rule10011','AT000003','age>30','2019-02-12 01:29:41','P000003','1');
insert into target_action_data values ('TA000012','rule10012','AT000003','Young Girls','2019-02-10 03:47:11','P000003','1');
insert into target_action_data values ('TA000013','rule10013','AT000003','...','2019-02-23 17:47:16','P000003','1');
insert into target_action_data values ('TA000014','rule10014','AT000003','P000012','2019-02-16 10:18:58','P000003','1');
insert into target_action_data values ('TA000015','rule10015','AT000003','age>30','2019-02-24 10:25:44','P000003','1');
insert into target_action_data values ('TA000016','rule10016','AT000004','Young Girls','2019-02-21 19:32:51','P000004','1');
insert into target_action_data values ('TA000017','rule10017','AT000004','...','2019-02-25 00:24:28','P000004','1');
insert into target_action_data values ('TA000018','rule10018','AT000004','P000012','2019-02-20 16:34:40','P000004','1');
insert into target_action_data values ('TA000019','rule10019','AT000004','age>30','2019-02-27 11:07:49','P000004','1');
insert into target_action_data values ('TA000020','rule10020','AT000004','Young Girls','2019-02-18 19:07:34','P000004','1');
insert into target_action_data values ('TA000021','rule10021','AT000005','...','2019-02-13 21:31:35','P000005','1');
insert into target_action_data values ('TA000022','rule10022','AT000005','P000012','2019-02-15 18:59:07','P000005','1');
insert into target_action_data values ('TA000023','rule10023','AT000005','age>30','2019-02-22 13:05:35','P000005','1');
insert into target_action_data values ('TA000024','rule10024','AT000005','Young Girls','2019-02-28 19:51:46','P000005','1');
insert into target_action_data values ('TA000025','rule10025','AT000005','...','2019-02-11 12:34:00','P000005','1');

	
insert into promotion_offer_data values ('PO000001','Get One For Free','PL000001','...','P000001','1');
insert into promotion_offer_data values ('PO000002','Buy With Fix Price','PL000001','P000012','P000001','1');
insert into promotion_offer_data values ('PO000003','Buy With Fix Price','PL000001','age>30','P000001','1');
insert into promotion_offer_data values ('PO000004','Free Shipping','PL000001','Young Girls','P000001','1');
insert into promotion_offer_data values ('PO000005','Get One For Free','PL000001','...','P000001','1');
insert into promotion_offer_data values ('PO000006','Buy With Fix Price','PL000002','P000012','P000002','1');
insert into promotion_offer_data values ('PO000007','Buy With Fix Price','PL000002','age>30','P000002','1');
insert into promotion_offer_data values ('PO000008','Free Shipping','PL000002','Young Girls','P000002','1');
insert into promotion_offer_data values ('PO000009','Get One For Free','PL000002','...','P000002','1');
insert into promotion_offer_data values ('PO000010','Buy With Fix Price','PL000002','P000012','P000002','1');
insert into promotion_offer_data values ('PO000011','Buy With Fix Price','PL000003','age>30','P000003','1');
insert into promotion_offer_data values ('PO000012','Free Shipping','PL000003','Young Girls','P000003','1');
insert into promotion_offer_data values ('PO000013','Get One For Free','PL000003','...','P000003','1');
insert into promotion_offer_data values ('PO000014','Buy With Fix Price','PL000003','P000012','P000003','1');
insert into promotion_offer_data values ('PO000015','Buy With Fix Price','PL000003','age>30','P000003','1');
insert into promotion_offer_data values ('PO000016','Free Shipping','PL000004','Young Girls','P000004','1');
insert into promotion_offer_data values ('PO000017','Get One For Free','PL000004','...','P000004','1');
insert into promotion_offer_data values ('PO000018','Buy With Fix Price','PL000004','P000012','P000004','1');
insert into promotion_offer_data values ('PO000019','Buy With Fix Price','PL000004','age>30','P000004','1');
insert into promotion_offer_data values ('PO000020','Free Shipping','PL000004','Young Girls','P000004','1');
insert into promotion_offer_data values ('PO000021','Get One For Free','PL000005','...','P000005','1');
insert into promotion_offer_data values ('PO000022','Buy With Fix Price','PL000005','P000012','P000005','1');
insert into promotion_offer_data values ('PO000023','Buy With Fix Price','PL000005','age>30','P000005','1');
insert into promotion_offer_data values ('PO000024','Free Shipping','PL000005','Young Girls','P000005','1');
insert into promotion_offer_data values ('PO000025','Get One For Free','PL000005','...','P000005','1');
...
insert into sec_user_data values ('SU000001','login','13900000001','','C183EC89F92A462CF45B95504792EC4625E847C90536EEFE512D1C9DB8602E95','0','2019-02-17 16:01:36','2019-02-13 13:43:22','UD000001',NULL,'BLOCKED','1');
insert into sec_user_data values ('SU000002','login0002','13900000002','suddy_chang@163.com','AC2F95628244C6975EB2C36942EA879ED93D93F5895EF3157733E4629FA86B92','9999999','2019-02-19 02:07:27','2019-02-18 00:08:18','UD000001',NULL,'BLOCKED0002','1');
insert into sec_user_data values ('SU000003','login0003','13900000003','','1A39AE05E011CF4B6ADE19307698831F4303CEB3FF5A9E21EEC0B21FB19B1050','0','2019-02-13 20:03:10','2019-02-28 01:52:10','UD000001',NULL,'BLOCKED0003','1');
insert into sec_user_data values ('SU000004','login0004','13900000004','suddy_chang@163.com','331D0B81C261072AB3E01D2D09A3D1F9B03F1E5F095D6BF7284F32BF85135D59','9999999','2019-02-18 08:16:17','2019-02-09 09:00:07','UD000001',NULL,'BLOCKED0004','1');
insert into sec_user_data values ('SU000005','login0005','13900000005','','CBDC109937F570CA1D5F223EC59F5368AF9380F9DBF7E553124132BB402ED457','0','2019-02-26 01:33:30','2019-03-01 11:49:54','UD000001',NULL,'BLOCKED0005','1');

	
insert into sec_user_blocking_data values ('SUB000001','currentUser()','2019-02-28 10:22:49','这个用户多次发送违反社区的帖子，现在把他给屏蔽了','1');
...
insert into login_history_data values ('LH000001','2019-02-19 12:20:32','192.168.1.1','登陆成功','SU000001','1');
insert into login_history_data values ('LH000002','2019-02-22 06:07:38','192.168.1.2','登陆成功0002','SU000001','1');
insert into login_history_data values ('LH000003','2019-02-16 01:23:50','192.168.1.1','登陆成功0003','SU000001','1');
insert into login_history_data values ('LH000004','2019-02-13 13:28:35','192.168.1.2','登陆成功0004','SU000001','1');
insert into login_history_data values ('LH000005','2019-02-26 05:13:03','192.168.1.1','登陆成功0005','SU000001','1');
insert into login_history_data values ('LH000006','2019-02-24 09:20:51','192.168.1.2','登陆成功0006','SU000002','1');
insert into login_history_data values ('LH000007','2019-02-13 06:23:20','192.168.1.1','登陆成功0007','SU000002','1');
insert into login_history_data values ('LH000008','2019-02-12 22:41:56','192.168.1.2','登陆成功0008','SU000002','1');
insert into login_history_data values ('LH000009','2019-02-12 06:15:54','192.168.1.1','登陆成功0009','SU000002','1');
insert into login_history_data values ('LH000010','2019-02-18 15:27:31','192.168.1.2','登陆成功0010','SU000002','1');
insert into login_history_data values ('LH000011','2019-02-09 09:31:02','192.168.1.1','登陆成功0011','SU000003','1');
insert into login_history_data values ('LH000012','2019-02-21 06:15:22','192.168.1.2','登陆成功0012','SU000003','1');
insert into login_history_data values ('LH000013','2019-02-20 06:23:26','192.168.1.1','登陆成功0013','SU000003','1');
insert into login_history_data values ('LH000014','2019-02-28 06:34:02','192.168.1.2','登陆成功0014','SU000003','1');
insert into login_history_data values ('LH000015','2019-02-19 01:54:05','192.168.1.1','登陆成功0015','SU000003','1');
insert into login_history_data values ('LH000016','2019-02-14 09:44:17','192.168.1.2','登陆成功0016','SU000004','1');
insert into login_history_data values ('LH000017','2019-02-16 05:14:30','192.168.1.1','登陆成功0017','SU000004','1');
insert into login_history_data values ('LH000018','2019-02-25 04:34:04','192.168.1.2','登陆成功0018','SU000004','1');
insert into login_history_data values ('LH000019','2019-02-15 12:11:43','192.168.1.1','登陆成功0019','SU000004','1');
insert into login_history_data values ('LH000020','2019-02-21 18:03:05','192.168.1.2','登陆成功0020','SU000004','1');
insert into login_history_data values ('LH000021','2019-03-02 06:45:00','192.168.1.1','登陆成功0021','SU000005','1');
insert into login_history_data values ('LH000022','2019-02-13 12:37:48','192.168.1.2','登陆成功0022','SU000005','1');
insert into login_history_data values ('LH000023','2019-02-24 18:04:16','192.168.1.1','登陆成功0023','SU000005','1');
insert into login_history_data values ('LH000024','2019-02-15 08:35:25','192.168.1.2','登陆成功0024','SU000005','1');
insert into login_history_data values ('LH000025','2019-02-11 16:45:42','192.168.1.1','登陆成功0025','SU000005','1');
...
create unique index idx_apply_condition_version on apply_condition_data(id, version);

alter table apply_condition_data add constraint apply_condition4platform_fk
	foreign key(platform) references platform_data(id) on delete cascade on update cascade;
create unique index idx_action_type_version on action_type_data(id, version);

alter table action_type_data add constraint action_type4platform_fk
	foreign key(platform) references platform_data(id) on delete cascade on update cascade;
create unique index idx_promotion_level_version on promotion_level_data(id, version);

alter table promotion_level_data add constraint promotion_level4platform_fk
	foreign key(platform) references platform_data(id) on delete cascade on update cascade;
create unique index idx_promotion_version on promotion_data(id, version);

alter table promotion_data add constraint promotion4platform_fk
	foreign key(platform) references platform_data(id) on delete cascade on update cascade;
create unique index idx_target_user_rule_version on target_user_rule_data(id, version);

alter table target_user_rule_data add constraint target_user_rule4apply_condition_fk
	foreign key(apply_condition) references apply_condition_data(id) on delete cascade on update cascade;
alter table target_user_rule_data add constraint target_user_rule4promotion_fk
	foreign key(promotion) references promotion_data(id) on delete cascade on update cascade;
create unique index idx_target_action_version on target_action_data(id, version);

alter table target_action_data add constraint target_action4action_fk
	foreign key(action) references action_type_data(id) on delete cascade on update cascade;
alter table target_action_data add constraint target_action4promotion_fk
	foreign key(promotion) references promotion_data(id) on delete cascade on update cascade;
create unique index idx_promotion_offer_version on promotion_offer_data(id, version);

alter table promotion_offer_data add constraint promotion_offer4promotion_level_fk
	foreign key(promotion_level) references promotion_level_data(id) on delete cascade on update cascade;
alter table promotion_offer_data add constraint promotion_offer4promotion_fk
	foreign key(promotion) references promotion_data(id) on delete cascade on update cascade;
...
create index apply_condition4last_update_time_idx on apply_condition_data(last_update_time);
create index apply_condition4version_idx on apply_condition_data(version);
create index action_type4last_update_time_idx on action_type_data(last_update_time);
create index action_type4version_idx on action_type_data(version);
create index promotion_level4last_update_time_idx on promotion_level_data(last_update_time);
create index promotion_level4version_idx on promotion_level_data(version);
create index promotion4valid_after_idx on promotion_data(valid_after);
create index promotion4expire_time_idx on promotion_data(expire_time);
create index promotion4last_update_time_idx on promotion_data(last_update_time);
create index promotion4version_idx on promotion_data(version);
create index target_user_rule4last_update_time_idx on target_user_rule_data(last_update_time);
create index target_user_rule4version_idx on target_user_rule_data(version);
create index target_action4last_update_time_idx on target_action_data(last_update_time);
create index target_action4version_idx on target_action_data(version);
create index promotion_offer4version_idx on promotion_offer_data(version);
...
insert into user_app_data values('UA000001','Platform','SU000001','at',1,'MXWR','Platform','P000001','/link/to/app','1'); -- REFER COUNT: 4
...
/* The sql file is not found from: /home/philip/resin-3.1.12/webapps/sky/data-patch/promoengine.sql */
