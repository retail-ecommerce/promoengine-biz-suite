...
这个类已经被配置到了相应的Spring配置文件 WEB-INF/promoengine_custom_src/META-INF/promoengine_custom.xml 中，
...
public class PromotionCustomManagerImpl extends PromotionManagerImpl{
