...
import com.doublechaintech.promoengine.PromoengineUserContextImpl;
import com.doublechaintech.promoengine.LoginForm;
import com.doublechaintech.promoengine.BaseEntity;
import com.doublechaintech.promoengine.CommonError;
import com.doublechaintech.promoengine.DAOGroup;
import com.doublechaintech.promoengine.ManagerGroup;

import com.doublechaintech.promoengine.UserContextImpl;
import com.doublechaintech.promoengine.userapp.UserApp;
import com.doublechaintech.promoengine.PromoengineUserContext;
import com.doublechaintech.promoengine.userapp.*;
import com.doublechaintech.promoengine.listaccess.*;
import com.doublechaintech.promoengine.objectaccess.*;
import com.doublechaintech.promoengine.PromoengineChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(PromoengineUserContext userContext){
    ...
    public Object resetPassword(PromoengineUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(PromoengineUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(PromoengineUserContext userContext,
    ...
    public SecUser manage(PromoengineUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(PromoengineUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(PromoengineUserContext userContext) {
    ...
    protected Object gotoApp(PromoengineUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(PromoengineUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(PromoengineUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(PromoengineUserContext userContex, int length){
    ...
    protected String getBeanName(PromoengineUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(PromoengineUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(PromoengineUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(PromoengineUserContext userContext, UserApp app){
    ...
    public Object home(PromoengineUserContext userContext) {
    ...
    public Object loginWithEmail(PromoengineUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(PromoengineUserContext userContext, String email,
            String password) {
    ...
    public Object loginWithLogin(PromoengineUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(PromoengineUserContext userContext, String email,
            String password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(PromoengineUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(PromoengineUserContext userContext, String type, String userId,
            String password) {
     ...
     */
    protected Object loginTheSecUserInternal(PromoengineUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(PromoengineUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(PromoengineUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        PromoengineUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected PromoengineChecker checker;
    public PromoengineChecker getChecker(){
        return checker;
    }
    
    public void setChecker(PromoengineChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((PromoengineChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected PromoengineUserContextImpl createNewConext(String path) {

        return new PromoengineUserContextImpl();
    ...
    public Object checkOtherLogin(PromoengineUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(PromoengineUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(PromoengineUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(PromoengineUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(PromoengineUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(PromoengineUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(PromoengineUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
