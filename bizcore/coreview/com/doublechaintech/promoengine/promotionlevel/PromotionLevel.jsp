<%@ page import='java.util.*,com.doublechaintech.promoengine.*,com.doublechaintech.promoengine.promotionlevel.PromotionLevel'%>
...
<c:set var="ownerBeanName" value="promotionLevel" scope="request"/>
<c:set var="ownerClassName" value="PromotionLevel" scope="request"/>
...
<div class="row">
	...
	<% PromotionLevel result = (PromotionLevel)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="promotionLevel" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/promoengine/promotionlevel/PromotionLevel$Summary.jsp" />
...
<sky:include page="com/doublechaintech/promoengine/platform/Platform$Info.jsp" />
		...
		<div id="promotionOfferList" class="tab-pane fade sublist" refer-name="promotion_level">
			<sky:include page="com/doublechaintech/promoengine/promotionoffer/PromotionOffer$List.jsp"
					referName="promotionLevel"/>
		</div>
	</c:if>
