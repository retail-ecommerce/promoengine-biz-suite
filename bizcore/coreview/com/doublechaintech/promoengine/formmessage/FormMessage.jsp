<%@ page import='java.util.*,com.doublechaintech.promoengine.*,com.doublechaintech.promoengine.formmessage.FormMessage'%>
...
<sky:include page="com/doublechaintech/promoengine/formmessage/FormMessage$Summary.jsp" />
