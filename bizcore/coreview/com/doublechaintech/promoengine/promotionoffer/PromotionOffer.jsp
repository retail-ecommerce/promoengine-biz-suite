<%@ page import='java.util.*,com.doublechaintech.promoengine.*,com.doublechaintech.promoengine.promotionoffer.PromotionOffer'%>
...
<c:set var="ownerBeanName" value="promotionOffer" scope="request"/>
<c:set var="ownerClassName" value="PromotionOffer" scope="request"/>
...
<div class="row">
	...
	<% PromotionOffer result = (PromotionOffer)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="promotionOffer" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/promoengine/promotionoffer/PromotionOffer$Summary.jsp" />
	...
	<div class="row">
<c:set var="promotionLevel" value="${ result.promotionLevel}" scope="request" />
<sky:include page="com/doublechaintech/promoengine/promotionlevel/PromotionLevel$Info.jsp" />

<c:set var="promotion" value="${ result.promotion}" scope="request" />
<sky:include page="com/doublechaintech/promoengine/promotion/Promotion$Info.jsp" />
