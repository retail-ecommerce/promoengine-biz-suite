<%@ page import='java.util.*,com.doublechaintech.promoengine.*,com.doublechaintech.promoengine.actiontype.ActionType'%>
...
<c:set var="ownerBeanName" value="actionType" scope="request"/>
<c:set var="ownerClassName" value="ActionType" scope="request"/>
...
<div class="row">
	...
	<% ActionType result = (ActionType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="actionType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/promoengine/actiontype/ActionType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/promoengine/platform/Platform$Info.jsp" />
		...
		<div id="targetActionList" class="tab-pane fade sublist" refer-name="action">
