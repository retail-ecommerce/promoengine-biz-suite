<%@ page import='java.util.*,com.doublechaintech.promoengine.*,com.doublechaintech.promoengine.loginhistory.LoginHistory'%>
...
<sky:include page="com/doublechaintech/promoengine/loginhistory/LoginHistory$Summary.jsp" />
