<%@ page import='java.util.*,com.doublechaintech.promoengine.*,com.doublechaintech.promoengine.secuser.SecUser'%>
...
<sky:include page="com/doublechaintech/promoengine/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/doublechaintech/promoengine/userdomain/UserDomain$Info.jsp" />
...
<sky:include page="com/doublechaintech/promoengine/secuserblocking/SecUserBlocking$Action.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/promoengine/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		...
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/promoengine/loginhistory/LoginHistory$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
