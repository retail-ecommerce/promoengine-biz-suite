<%@ page import='java.util.*,com.doublechaintech.promoengine.*,com.doublechaintech.promoengine.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/doublechaintech/promoengine/secuserblocking/SecUserBlocking$Summary.jsp" />
