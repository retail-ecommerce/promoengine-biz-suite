<%@ page import='java.util.*,com.doublechaintech.promoengine.*,com.doublechaintech.promoengine.listaccess.ListAccess'%>
...
<sky:include page="com/doublechaintech/promoengine/listaccess/ListAccess$Summary.jsp" />
