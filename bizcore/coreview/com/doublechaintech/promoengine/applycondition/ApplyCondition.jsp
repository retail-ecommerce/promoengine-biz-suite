<%@ page import='java.util.*,com.doublechaintech.promoengine.*,com.doublechaintech.promoengine.applycondition.ApplyCondition'%>
...
<c:set var="ownerBeanName" value="applyCondition" scope="request"/>
<c:set var="ownerClassName" value="ApplyCondition" scope="request"/>
...
<div class="row">
	...
	<% ApplyCondition result = (ApplyCondition)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="applyCondition" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/promoengine/applycondition/ApplyCondition$Summary.jsp" />
...
<sky:include page="com/doublechaintech/promoengine/platform/Platform$Info.jsp" />
		...
		<div id="targetUserRuleList" class="tab-pane fade sublist" refer-name="apply_condition">
			<sky:include page="com/doublechaintech/promoengine/targetuserrule/TargetUserRule$List.jsp"
					referName="applyCondition"/>
		</div>
	</c:if>
