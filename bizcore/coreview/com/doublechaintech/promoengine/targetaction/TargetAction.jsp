<%@ page import='java.util.*,com.doublechaintech.promoengine.*,com.doublechaintech.promoengine.targetaction.TargetAction'%>
...
<c:set var="ownerBeanName" value="targetAction" scope="request"/>
<c:set var="ownerClassName" value="TargetAction" scope="request"/>
...
<div class="row">
	...
	<% TargetAction result = (TargetAction)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="targetAction" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/promoengine/targetaction/TargetAction$Summary.jsp" />
	...
	<div class="row">
<c:set var="actionType" value="${ result.action}" scope="request" />
<sky:include page="com/doublechaintech/promoengine/actiontype/ActionType$Info.jsp" />
