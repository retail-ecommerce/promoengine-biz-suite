<%@ page import='java.util.*,com.doublechaintech.promoengine.*,com.doublechaintech.promoengine.targetuserrule.TargetUserRule'%>
...
<c:set var="ownerBeanName" value="targetUserRule" scope="request"/>
<c:set var="ownerClassName" value="TargetUserRule" scope="request"/>
...
<div class="row">
	...
	<% TargetUserRule result = (TargetUserRule)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="targetUserRule" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/promoengine/targetuserrule/TargetUserRule$Summary.jsp" />
	...
	<div class="row">
<c:set var="applyCondition" value="${ result.applyCondition}" scope="request" />
<sky:include page="com/doublechaintech/promoengine/applycondition/ApplyCondition$Info.jsp" />
