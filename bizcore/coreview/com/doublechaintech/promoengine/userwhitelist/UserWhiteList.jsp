<%@ page import='java.util.*,com.doublechaintech.promoengine.*,com.doublechaintech.promoengine.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechaintech/promoengine/userwhitelist/UserWhiteList$Summary.jsp" />
