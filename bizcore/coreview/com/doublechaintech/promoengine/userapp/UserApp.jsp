<%@ page import='java.util.*,com.doublechaintech.promoengine.*,com.doublechaintech.promoengine.userapp.UserApp'%>
...
<sky:include page="com/doublechaintech/promoengine/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/doublechaintech/promoengine/secuser/SecUser$Info.jsp" />
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/promoengine/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/promoengine/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
